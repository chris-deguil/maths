...
$$\abs{x} \leqslant r \ssi x \in [-r\,;\,r]
\qquad\text{et}\qquad
\abs{x} < r \ssi x \in ]-r\,;\,r[$$
:::
...
$$\abs{x - a} \leqslant r \ssi x \in [a-r\,;\,a+r]$$
:::
...
Pour tout réel $x$ :
$x \in [a-r\,;\,a+r] \ssi -r \leqslant x-a \leqslant r \ssi \abs{x-a} \leqslant r$.
...
Pour tout réel $x$, 
$$\abs{2x-1} < \frac{5}{2}
\ssi -\frac{5}{2} < 2x-1 < \frac{5}{2}
\ssi -\frac{3}{2} < 2x < \frac{7}{2}
\ssi -\frac{3}{4} < x < \frac{7}{4}$$
