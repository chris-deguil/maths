...
<div style="text-align: center;">
  <img src="../../image/seconde/Intervalles_Inegalites_distance_zero1.png" style="width: 25%;">
</div>
:::
...
Pour tout réel $x$, 
$$\abs{x-3} = 5 \iff x-3 = 5 \ou x-3 = -5 \iff x = 8 \ou x = -2$$
...
Pour tout réel $x$, 
$$\abs{2-3x} = 4 \iff 2-3x = 4 \ou 2-3x = -4 \iff x = -\dfrac{2}{3} \ou x = 2$$
...
Pour tout réel $x$, 
$$\abs{3-5x} = \abs{x+3} \iff 3-5x = x+3 \ou 3-5x = -(x+3)$$

- D'une part, $3-5x = x+3 \iff -6x = 0 \iff x = 0$
- D'autre part, 
  $3-5x = -x-3 \iff -4x = -6 \iff x = \dfrac{3}{2}$
