...
::: {.bloc .ex}
<div class="bloc-titre">Exercice :<span class="exemp-extra"> Tracer la droite représentative : méthode 1</span></div>
...
::: {.bloc .ex}
<div class="bloc-titre">Exercice :<span class="exemp-extra"> Tracer la droite représentative : méthode 2</span></div>
...
::: {.bloc .exo}
<span class="exo-num"></span><span class="exo-extra"> Tracer une droite et lire un antécédent — Représenter, Calculer </span>
