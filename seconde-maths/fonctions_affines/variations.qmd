...
::: {.bloc .ex}
<div class="bloc-titre">Exercice :<span class="exemp-extra"> Dresser le tableau de variations — Représenter</span></div>
...
::: {.bloc .exo}
<span class="exo-num"></span><span class="exo-extra"> Reconnaître $m$ à partir d'un tableau de variations — Raisonner </span>
