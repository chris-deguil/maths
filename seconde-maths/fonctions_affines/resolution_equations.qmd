...
::: {.bloc .sfc}
<div class="bloc-titre">Savoir - faire :<span class="exemp-extra"> Résoudre $f(x)=k$ algébriquement — Calculer </span></div>
...
$3x-1=5 \iff 3x=6 \iff x=2$.

L'équation a pour ensemble solution $S= \{2\}$.
...
Le point d'ordonnée $5$ de la représentation graphique de la fonction affine $f:x \longmapsto 3x-1$ a pour abscisse $2$.
...
::: {.bloc .sfc}
<div class="bloc-titre">Savoir-Faire :<span class="exemp-extra"> Résolution graphique — Représenter, Calculer</span></div>
...
<div style="text-align: center;">
  <img src="../../image/seconde/Fonction_Affine_exo_intersection1.png" style="width: 30%;">
</div>
