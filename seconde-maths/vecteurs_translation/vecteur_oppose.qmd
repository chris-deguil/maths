...
::: {.bloc .rem}
<span class="bloc-titre">Point méthode — soustraire deux vecteurs : </span>
...
::: {.bloc .sfc}
<div class="bloc-titre">Savoir-Faire :<span class="exemp-extra"> Simplifier une différence de vecteurs — Calculer</span></div>
...
::: {.bloc .ex}
<div class="bloc-titre">Exercice :<span class="exemp-extra"> Vecteur opposé dans un parallélogramme — Calculer, Raisonner</span></div>
