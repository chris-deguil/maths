...
::: {.bloc .ex}
<div class="bloc-titre">Exercice :<span class="exemp-extra"> Simplifier par la relation de Chasles — Calculer</span></div>
...
::: {.bloc .sf}
<div class="bloc-titre">Savoir faire :<span class="sf"> Point méthode — utiliser la relation de Chasles</span></div>
...
::: {.bloc .exo}
<span class="exo-num"></span><span class="exo-extra"> Application de Chasles — Raisonner </span>
