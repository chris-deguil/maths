...
2. $C \subset A$ car $2 \in A$ et $6 \in A$ : tout élément de $C$ appartient à $A$. $C \subset B$ car $2 \in B$ et $6 \in B$ : tout élément de $C$ appartient à $B$.
3. $\{1\,;\,3\} \not\subset B$ car $1 \notin B$.
4. $A \cap B = \{2\,;\,6\}$ (éléments communs aux deux ensembles). $A \cup B = \{1\,;\,2\,;\,3\,;\,4\,;\,6\,;\,8\}$ (tous les éléments).
5. Non : $1 \in A$ mais $1 \notin B$, donc $A \not\subset B$.
